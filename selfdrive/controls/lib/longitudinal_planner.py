...
# make sure these accelerations are smaller than mpc limits
_A_CRUISE_MAX_V = [0.8, 1.0, 0.65, .3]
_A_CRUISE_MAX_V_FOLLOWING = [0.8, 1.0, 0.65, .3]
_A_CRUISE_MAX_BP = [0., 19., 25., 40.]

# Lookup table for turns - fast accel
_A_TOTAL_MAX_V = [3., 3.5, 4.0]
_A_TOTAL_MAX_BP = [0., 25., 40.]

# Lookup table for turns original - used when slowOnCurves = 1 from kegman.json
_A_TOTAL_MAX_V_SOC = [1.2, 1.7]
_A_TOTAL_MAX_BP_SOC = [15., 33.]
